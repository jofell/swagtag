...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.shadowColor = [UIColor colorWithWhite:40.0/255.0 alpha:1.0];
    ...
    UIImage *icon = [UIImage imageNamed:[[[titlesArray objectAtIndex:indexPath.row] lowercaseString] stringByReplacingOccurrencesOfString:@" " withString:@"-"]];
    
    cell.imageView.image = [icon resizedImageWithContentMode:UIViewContentModeScaleAspectFit
                                                      bounds:CGSizeMake(15.0, 15.0)
