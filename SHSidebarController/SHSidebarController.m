...
-(void)closeAndPop{
    ...
    [self.mainVC.view hideOrigamiTransitionWith:self.menuVC.view NumberOfFolds:1 Duration:.3 Direction:XYOrigamiDirectionFromLeft completion:^(BOOL finished) {
        ...
        UIBarButtonItem *src = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"lines"] style:UIBarButtonItemStylePlain target:self action:@selector(menuChange)];
        src.tintColor = [UIColor colorWithWhite:40.0/255.0 alpha:1.0];
